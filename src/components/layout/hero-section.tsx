            ...
            <div className="container mx-auto px-4 py-24 md:py-32">
                <div className="max-w-4xl mx-auto text-center space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
                        <Button render={<Link href="/search" />} size="lg" className="min-w-[200px]">
                            Shop Now
                        </Button>
                        <Button render={<a href="https://github.com/vendure-ecommerce/nextjs-starter-vendure" target="_blank" rel="noopener noreferrer" />} variant="outline" size="lg" className="min-w-[200px]">
